...
<section class="my-[64px] md:my-[80px] <?= $customClass; ?>">
  <div class="tb_container">
    <div
      class="bg-[var(--color-royal-blue)] rounded-[24px] md:rounded-[48px] px-[16px] py-[70px] md:py-[80px] text-center text-white "
      ...
      ?>
      <a class="btn btn-navy mt-[30px] md:mt-[50px] !px-[40px] " href="/contact/">
        Get Started
      </a>
      <?php endif; ?>
    </div>
