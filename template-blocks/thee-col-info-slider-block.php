...
<div class="tb_container">
    ...
    <?php if (get_sub_field('section_title')) { ?>
      <h2 class="lg:text-[60px] md:text-[55px] text-[52px] text-navy text-center mb-[31px]">
      ...
      <div class="swiper-wrapper">
        ...
        ?>
          <div class="swiper-slide md:w-[calc(33.3%-12px)]">
            ...
            <h3 class="mt-[9px] text-[30px] text-navy font-secondary font-bold">
              <?php echo get_sub_field('title');  ?>
            </h3>
            <p class="mt-[17px] text-[16px] text-navy ">
