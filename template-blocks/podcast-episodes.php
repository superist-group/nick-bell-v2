              ...
              <div class="flex items-center gap-4">
                <?php if ($spotify_link) : ?>
                  <a href="<?= $spotify_link ?>" target="_blank" onclick="event.stopPropagation();">
                    <img style="height: 50px"
                      src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/spotify-colored.png" alt="Spotify" />
                  </a>
                <?php endif; ?>
                ...
                <?php if ($apple_music_link) : ?>
                  <a href="<?= $apple_music_link ?>" target="_blank" onclick="event.stopPropagation();">
                    <img style="height: 50px"
                      src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/applepodcasts.png"
                      alt="Apple Podcasts" />
                  </a>
                <?php endif; ?>
              </div>
