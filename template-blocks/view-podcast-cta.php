...
<section class="bg-[#0a1124] relative cta-section pt-[48px] md:py-[48px] md:pl-[40%] lg:pl-0" >
  <img src="<?php echo $background_dkt; ?>" alt="" class="hidden md:block absolute inset-0 left-0 top-0 w-full h-full object-cover md:object-[20%_15%] lg:object-left-top">
  ...
  <div class="tb_container relative lg:flex align-items-center justify-between  ">
    ...
    <div class="center-data lg:w-1/3 text-center">
      ...
      ?>
        <a class="btn btn-light-blue mt-[32px]" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>"><?php echo esc_html( $link_title ); ?></a>
      <?php endif; ?>
    </div>
