        ...
        <div class="platform-links">
          <?php if ($youtube = get_field('social_media_youtube', 'option')) : ?>
            <a class="social-platform-icon" href="<?php echo esc_url($youtube); ?>" target="_blank" rel="noopener">
              <img class="mx-auto" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/youtube.png"
                alt="Youtube">
            </a>
          <?php endif; ?>
          <?php if ($spotify = get_field('social_media_spotify', 'option')) : ?>
            <a class="social-platform-icon" href="<?php echo esc_url($spotify); ?>" target="_blank" rel="noopener">
              <img class="mx-auto" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/spotify.png"
                alt="Spotify">
            </a>
          <?php endif; ?>
          <?php if ($apple_podcasts = get_field('social_media_apple_podcasts', 'option')) : ?>
            <a class="social-platform-icon" href="<?php echo esc_url($apple_podcasts); ?>" target="_blank" rel="noopener">
              <img class="mx-auto" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/applepodcasts.png"
                alt="Apple Podcasts">
            </a>
          <?php endif; ?>
        </div>
...
<script type="text/javascript" id="hs-script-loader" async defer src="//js.hs-scripts.com/48534028.js"></script>
